...
var combats = [
	...
	},
	{
		id: 9,
		name: "an orc chef",
		description: "Spending all of your day toiling over producing enormous amounts of disgusting slop for a large orc army is enough to make anybody miserable. It's grueling work to produce enough gruel to feed an entire army, and nobody appreciates it. So when a human walks up to the food and looks at it with a mixture of horror and disgust, it would be the tipping point to make anyone snap.</p><p>Which is exactly what just happened.",
		icon: "orc_chef.png",
		hp: 16,
		pow: 10,
		def: 1,
